          ...
          <div className='lg:col-start-2'>
            ...
            {order._isPaid ? (
              <p className='mt-2 text-base text-muted-foreground'>
                ...
                donwload below. We&apos;ve sent your receipt and order details
                to{' '}
              ...
              <p className='mt-2 text-base text-muted-foreground'>
                Wee appreciate your order, wee&apos;re currently processing it.
                So hang itht and wee&apos;ll send you confirmation very soon!
              </p>
            )}
                      ...
                      <div className='flex-auto flex flex-col justify-between'>
                        ...
                        {order._isPaid ? (
                          <a
                            ...
                            className='text-blue-600 hover:text-blue-500 hover:underline underline-offset-2'
                          >
                            Download asset
                          </a>
                        ) : null}
